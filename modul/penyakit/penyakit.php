  ...
  switch ($_GET[act]) {
    ...
    default:
      ...
      echo "<form method=POST action='?module=penyakit' name=text_form onsubmit='return Blank_TextField_Validator_Cari()'>
		  ...
		  <tr><td><input class='btn btn-success ' type=button name=tambah value='Tambah Penyakit' onclick=\"window.location.href='?module=penyakit&act=tambahpenyakit';\"></td>
        ...
        if ($numrows > 0) {
          ...
          while ($r = mysqli_fetch_array($hasil)) {
            ...
            echo "<tr class='" . $warna . "'>
			 ...
			 <td align=center><a type='button' class='btn btn-block btn-success' href=?module=penyakit&act=editpenyakit&id=$r[kode_penyakit]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Ubah </a> &nbsp;
        ...
        if ($baris > 0) {
          ...
          while ($r = mysqli_fetch_array($hasil)) {
            ...
            echo "<tr class='" . $warna . "'>
			 ...
			 <td>$r[srn_penyakit]</td>
			 <td align=center>
			 <a type='button' class='btn btn-block btn-success' href=?module=penyakit&act=editpenyakit&id=$r[kode_penyakit]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Ubah </a> &nbsp;
          ...
          if ($offset!=0) {
			...
			echo "<span class='btn btn-square btn-outline-light btn-xs'> <a href=index.php?module=penyakit&offset=$prevoffset>Back</a></span>";
		}
		else {
          ...
          for ($i = 1; $i <= $halaman; $i++) {
            $newoffset = $limit * ($i - 1);
            if ($offset != $newoffset) {
              echo "<span class='btn btn-square btn-outline-light btn-xs'><a href=index.php?module=penyakit&offset=$newoffset>$i</a></span>";
              //cetak halaman
            } else {
          ...
          if (!(($offset / $limit) + 1 == $halaman) && $halaman != 1) {
            ...
            echo "<span class='btn btn-square btn-outline-light btn-xs'><a href=index.php?module=penyakit&offset=$newoffset>Next</a>";
          } else {
