...
switch ($_GET[act]) {
    ...
    default:
        ...
        echo "<form method=POST action='?module=post' name=text_form onsubmit='return Blank_TextField_Validator_Cari()'>
		  ...
		  <tr><td><input class='btn btn-success' type=button name=tambah value='Tambah Post' onclick=\"window.location.href='?module=post&act=tambahpost';\"></td>
		  <td><input type=text name='keyword' style='margin-left: 10px;' placeholder='Ketik dan tekan cari...' class='form-control' value='$_POST[keyword]' /> </td>
		  <td><input class='btn btn-success' type=submit value='   Cari   ' name=Go></td> </tr>
          </table></form>";
        ...
        if ($_POST[Go]) {
		  ...
		  <tbody>";
			 ...
			 <td>$r[det_post]</td>
			 <td>$r[srn_post]</td>
			 <td align=center><a type='button' class='btn btn-success margin' href=?module=post&act=editpost&id=$r[kode_post]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Ubahx </a> &nbsp;
		  ...
		  ";
			 ...
			 <td>$r[srn_post]</td>
			 <td align=center>
			 <a type='button' class='btn btn-success margin' href=?module=post&act=editpost&id=$r[kode_post]><i class='fa fa-pencil-square-o' aria-hidden='true'></i> Ubah </a> &nbsp;
		...
		echo "<span class='btn btn-square btn-outline-light btn-xs'> <a href=index.php?module=post&offset=$prevoffset>Back</a></span>";
	}
	else {
	...
	for($i=1;$i<=$halaman;$i++){
		$newoffset = $limit * ($i-1);
		if($offset!=$newoffset){
			echo "<span class='btn btn-square btn-outline-light btn-xs'><a href=index.php?module=post&offset=$newoffset>$i</a></span>";
			//cetak halaman
		}
		else {
	...
	if(!(($offset/$limit)+1==$halaman) && $halaman !=1){
		...
		echo "<span class='btn btn-square btn-outline-light btn-xs'><a href=index.php?module=post&offset=$newoffset>Next</a>";
	}
	else {
    ...
    case "tambahpost":
        echo "<form name=text_form method=POST action='$aksi?module=post&act=input' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
		  ...
		  <tr><td width=120>Detail Post</td><td> <textarea class='summernote' id='editor1' rows='4' cols='50' class='form-control' name='det_post'type=text placeholder='Masukkan detail post baru...'></textarea></td></tr>
		  <tr><td width=120>Saran Post</td><td><textarea class='summernote' id='editor2' rows='4' cols='50' class='form-control' name='srn_post'type=text placeholder='Masukkan saran post baru...'></textarea></td></tr>
    ...
    case "editpost":
        ...
        echo "<form name=text_form method=POST action='$aksi?module=post&act=update' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
		  ...
		  <tr><td width=120>Detail Post</td><td><textarea class='summernote' id='editor1' rows='4' cols='50' type=text class='form-control' name='det_post'>$r[det_post]</textarea></td></tr>
		  <tr><td width=120>Saran Post</td><td><textarea class='summernote' id='editor2' rows='4' cols='50' type=text class='form-control' name='srn_post'>$r[srn_post]</textarea></td></tr>
